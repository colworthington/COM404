...
class Gui(Tk):
    ...
    def __init__(self):
        ...
        self.santa_image = PhotoImage(file="C:/Users/kkcolin.ENTERPRISE/Documents/GitHub/COM404/AE2/santa.gif")
    ...
    def __add_name_entry(self):
        ...
        self.name_entry.grid(row=1, column=1, sticky=N+E+S+W)
    ...
    def __add_message_box_label(self):
        ...
        self.message_box_label = Text(self.global_frame)
        self.message_box_label.grid(row=2, column=1, sticky=E)
        self.message_box_label.configure(bg="#fff", fg="blue", font="Arial 8", relief=SUNKEN, height=5, width=30)
        #ipadx=80, ipady=30

    def __add_post_button(self):
        self.post_button = Button(self.global_frame)
        self.post_button.grid(row=3, column=0, columnspan=2, sticky=N+E+S+W) 
        #sticky=N+E+S+W)
