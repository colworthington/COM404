...
class AnimatedGui(Tk):
    def __init__(self):
        ...
        # load resources
        self.red_ball_image = PhotoImage(file="//pclures06/home/4wortc73/Documents/Problem Solving/COM404/2-guis/5-animation/3-varying-ticks/red_ball.gif")
        self.blue_ball_image = PhotoImage(file="//pclures06/home/4wortc73/Documents/Problem Solving/COM404/2-guis/5-animation/3-varying-ticks/blue_ball.gif")
